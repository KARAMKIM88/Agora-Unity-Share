...
public class GameController : MonoBehaviour
{
    ...
    void SetupUI()
    {
        ...
        myView = go.GetComponent<RawImage>();
        myView.gameObject.AddComponent<VideoSurface>();

        go = GameObject.Find("ShareView");
        screenView = go.GetComponent<RawImage>();
        screenView.gameObject.AddComponent<VideoSurface>();
    ...
    void OnUserJoined(uint uid, int elapsed)
    {
        ...
        remoteView = go.GetComponent<RawImage>();
